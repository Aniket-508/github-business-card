...
import { GitHubQRCode } from "./github-qrcode";
...
const GithubCard = forwardRef(function (
  ...
  return (
    <div
      ref={ref}
      className="w-[600px] aspect-[1.75/1] bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-900 overflow-hidden transform transition-all hover:scale-[1.02] relative"
    >
      ...
      <div className="flex h-full">
        ...
        <div className="w-2/5 pt-4 pl-6 pr-4 pb-4 flex flex-col justify-between border-r border-gray-100">
          <div>
            <div className="mb-4 ">
              <Image
                src={user.avatar_url}
